...
function LEVEL1() {
	...
	const handleSubmit = (e) => {
		...
		if (response.toLowerCase() === "cede") {
			const encrypted = CryptoJS.AES.encrypt("2", "byp4ss").toString();
			...
			{value >= 1 ? (
				<div className=" flex flex-col items-center justify-center">
					<form
						...
						className=" p-6 bg-black text-black rounded-md shadow-md"
					>
						<input
							type="text"
							id="response"
						...
						<button
							type="submit"
							className="mt-4 bg-blue-500 text-black px-4 py-2 rounded-md"
						>
							Submit
						</button>
					</form>
					<div className=" p-6 bg-black  rounded-md shadow-md mt-4  text-white">
						Hient{" "}
					</div>
				</div>
			) : (
